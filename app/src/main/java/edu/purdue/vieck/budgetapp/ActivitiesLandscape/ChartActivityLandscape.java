package edu.purdue.vieck.budgetapp.ActivitiesLandscape;
...
import edu.purdue.vieck.budgetapp.Activities.DashboardActivity;
...
public class ChartActivityLandscape extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.nav_item_chart:
                        intent = new Intent(currentActivity, ChartActivityLandscape.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        currentActivity.startActivity(intent);
                        break;
